...
import { ScriptABI, EntryFunctionABI, TransactionScriptABI, ArgumentABI } from "./abi";
...
describe("ABI", () => {
    it("parses create_account successfully", async () => {
        ...
        const entryFunctionABI = ScriptABI.deserialize(deserializer);
    ...
    it("parses script abi successfully", async () => {
        ...
        const transactionScriptABI = ScriptABI.deserialize(deserializer);
