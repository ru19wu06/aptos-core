...
const ApiExplorer = ({ network, layout }) => (
// BrowserOnly is important here because of details re SSR:
// https://docusaurus.io/docs/advanced/ssg#browseronly
<BrowserOnly fallback={<div>Loading...</div>}>
    {() => {
        return (<API apiDescriptionUrl={`https://raw.githubusercontent.com/aptos-labs/aptos-core/${network}/api/doc/spec.yaml`} router="hash" layout={layout}/>);
    }}
  </BrowserOnly>);
