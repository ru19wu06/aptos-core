...
const WithBackgroundImage = ({ children, className, imageDark, imageDarkHover, imageLight, imageLightHover, ...props }) => {
    ...
    return (<div className={className} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} style={backgroundImageStyle} {...props}>
      {children}
    </div>);
};
