...
const SimpleTextCard = ({ bolded, icon, iconDark, overlay, smallerImage, title, to }) => (<BaseContainer className={styles.root} overlay={overlay} to={to}>
    <WithBackgroundImage className={clsx(styles.image, {
        [styles.smaller]: smallerImage,
    })} imageLight={icon} imageDark={iconDark}/>
